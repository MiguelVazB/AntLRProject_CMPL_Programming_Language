1,0,0,0,80,83,1,0,0,0,81,79,1,0,0,0,81,82,1,0,0,0,82,85,1,0,0,
        0,83,81,1,0,0,0,84,76,1,0,0,0,84,85,1,0,0,0,85,86,1,0,0,0,86,87,
        5,8,0,0,87,17,1,0,0,0,88,89,5,9,0,0,89,91,3,20,10,0,90,92,5,29,0,
        0,91,90,1,0,0,0,91,92,1,0,0,0,92,93,1,0,0,0,93,94,5,8,0,0,94,19,
        1,0,0,0,95,96,6,10,-1,0,96,106,3,22,11,0,97,106,5,30,0,0,98,106,
        3,16,8,0,99,100,5,6,0,0,100,101,3,20,10,0,101,102,5,8,0,0,102,106,
        1,0,0,0,103,104,5,10,0,0,104,106,3,20,10,6,105,95,1,0,0,0,105,97,
        1,0,0,0,105,98,1,0,0,0,105,99,1,0,0,0,105,103,1,0,0,0,106,126,1,
        0,0,0,107,108,10,5,0,0,108,109,5,23,0,0,109,125,3,20,10,6,110,111,
        10,4,0,0,111,112,7,0,0,0,112,125,3,20,10,5,113,114,10,3,0,0,114,
        115,7,1,0,0,115,125,3,20,10,4,116,117,10,2,0,0,117,118,3,24,12,0,
        118,119,3,20,10,3,119,125,1,0,0,0,120,121,10,1,0,0,121,122,3,26,
        13,0,122,123,3,20,10,2,123,125,1,0,0,0,124,107,1,0,0,0,124,110,1,
        0,0,0,124,113,1,0,0,0,124,116,1,0,0,0,124,120,1,0,0,0,125,128,1,
        0,0,0,126,124,1,0,0,0,126,127,1,0,0,0,127,21,1,0,0,0,128,126,1,0,
        0,0,129,130,7,2,0,0,130,23,1,0,0,0,131,132,7,3,0,0,132,25,1,0,0,
        0,133,134,7,4,0,0,134,27,1,0,0,0,12,31,39,44,51,55,65,81,84,91,105,
        124,126
    ]
...
class CMPLParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "<INVALID>", "<INVALID>", "<INVALID>", 
                      ...
                      "OP_MUL", "OP_DIV", "OP_POW", "FLOAT", "STRING", "NULL", 
                      "BOOLEAN", "WHILE", "PLUS_PLUS", "VAR", "NEWLINE", 
                      "INT", "WS" ]
    ...
    ruleNames =  [ "prog", "stmts", "stmt", "if_scope", "else_if_scope", 
                   ...
                   "show_stmt", "expr", "data_type", "comparison_op", "logic_op" ]
    ...
    def prog(self):
        ...
        try:
            ...
            while ((_la) & ~0x3f) == 0 and ((1 << _la) & 1342177794) != 0:
                self.state = 28
                self.stmts()
                self.state = 33
                self._errHandler.sync(self)
    ...
    def funct_call(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if ((_la) & ~0x3f) == 0 and ((1 << _la) & 5620368448) != 0:
                self.state = 76
                self.expr(0)
                self.state = 81
                self._errHandler.sync(self)
    ...
    def show_stmt(self):
        ...
        try:
            ...
            if _la==29:
                self.state = 90
                self.match(CMPLParser.PLUS_PLUS)
    ...
    def data_type(self):
        ...
        try:
            ...
            self.state = 129
            _la = self._input.LA(1)
            if not(((_la) & ~0x3f) == 0 and ((1 << _la) & 4546625536) != 0):
